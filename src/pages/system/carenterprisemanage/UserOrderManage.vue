    ...
    <el-row style="width:100%">
        ...
        <el-col :span="24" class="toolbar">
            <el-form :inline="true" size="small" :model="conditions">
                <el-form-item label="车企:" v-if="userInfo.userType==1">
                  <el-input v-model="conditions.enterpriseName" style="width: 200px" @focus="userDialogVisible=true" placeholder="请选择车企" />
                </el-form-item>
        ...
        <el-col :span="24">
            <el-button type="primary"
                       @click="addNewOrder"
                       icon="el-icon-plus"
                       style="float: right;margin-bottom: 10px" size="small">车主套餐
            </el-button>
            <el-dialog title="车主套餐 - 新增"
                       :visible.sync="addOrderDialogVisible"
                       width="70%">
                <UserAddOffer @closeAddNewOrder = "closeAddNewOrder" @queryOrder="queryOrder" :ruleData="ruleData"></UserAddOffer>
            </el-dialog>
        </el-col>
        <!-- table -->
        <el-col :span="24">
        ...
        <!--编辑属性-->
        <el-dialog title="修改套餐" :visible.sync="editOfferVisible" width="70%">
            <el-form
                ref="editDataForm"
                :model="editDataForm"
                :rules="myRules"
                ...
                <el-form-item label="关停限额" prop="mount" placeholder="请输入车主信用额度">
                    <el-input v-model="editDataForm.closeNum">
                        <el-select v-model="editDataForm.closeNumUnit" slot="append" placeholder="单位" style="width: 10px">
        ...
        <el-dialog title="编辑产品属性值" :visible.sync="editAttributeVisible">
            <el-form ref="editDataForm"
              ...
              <el-form-item label="资源类型" prop="resType" placeholder="请选择资源类型">
                <el-select v-model="editDataForm.resType" @change="changeUnit">
      ...
      <el-dialog title="新增产品属性值" :visible.sync="addServiceCodeArgVisible">
        <CreateServiceCodeArg :parentProductId="parentProductId" :closeDialig="closeCSCADialog"></CreateServiceCodeArg>
      </el-dialog>
...
<script>
    ...
    import UserAddOffer from './UserAddOffer';
                ...
                this.$refs[form].validate((valid) => {
                    if (valid) {
                        let params = {
                            ...
                            status: 1,
                            ext3:this.editDataForm.closeNum+this.editDataForm.closeNumUnit
                        };
